...
const Contact: NextPage = () => {
  ...
  return (
    <Layout>
      <Meta title="Contact" description="Entrez en contact avec gBoole01" />

      <Section>
        <ContactIntro>
          <PageTitle>Contact</PageTitle>
          <p>
            Si vous souhaitez échanger sur n'importe quel sujet, vous pouvez
            m'envoyer un message avec le formulaire suivant.
          </p>
        </ContactIntro>
        <Form onSubmit={handleSubmit}>
          <Label htmlFor="name">
            <span>
              Votre Nom <LabelRequired>*</LabelRequired>
            </span>
            <Input
              type="text"
              id="name"
            ...
            />
            {errors?.name && (
              <InputError>Le nom ne peut pas être vide</InputError>
            )}
          </Label>

          <Label htmlFor="email">
            <span>
              Votre E-mail <LabelRequired>*</LabelRequired>
            </span>
            <Input
              type="text"
              id="email"
            ...
            />
            {errors?.email && (
              <InputError>L'adresse mail ne peut pas être vide</InputError>
            )}
            {!errors?.email && errors?.emailFormat && (
              <InputError>L'adresse mail n'est pas au bon format</InputError>
            )}
          </Label>

          <Label htmlFor="message">
            <span>
              Votre Message <LabelRequired>*</LabelRequired>
            </span>
            <Textarea
              name="message"
              id="message"
            ...
            />
            {errors?.message && (
              <InputError>Le message ne peut pas être vide</InputError>
            )}
          </Label>
