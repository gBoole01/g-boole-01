        ...
        <>
            <Grid.Container alignItems="center">
                ...
                <Grid xs={12} sm={4} justify="center">
                    <Avatar
                        src="/images/g-boole-01-avatar.png"
                        css={{ size: "150px" }}
                    />
                </Grid>
            </Grid.Container>
            <Row css={{ margin: "$md 0", flexDirection: "column" }}>
                <Text>
                    Je suis un <Text b>développeur Full Stack</Text>, passionné
                    par la conception et la mise en œuvre de sites web et
                    d'applications.
                </Text>
                <Text>
                    Grâce à mes connaissances en <Text b>Javascript</Text>,{" "}
                    <Text b>Typescript</Text> et en <Text b>PHP</Text>, je suis
                    en train de développer mes compétences dans les dernières
                    technologies du marché, comme <Text b>Next</Text>,{" "}
                    <Text b>React</Text> et <Text b>Symfony</Text>.
                </Text>
                <Text>
                    Je suis enthousiaste à l'idée de continuer à apprendre et de
                    développer mes compétences pour offrir des solutions de
                    qualité supérieure.
                </Text>
                <Text>
                    Si vous êtes intéressé par mon parcours et mes projets en
                    cours, je vous invite à consulter mon portfolio et à me
        ...
        <Grid.Container gap={1} css={{ margin: "$3xl 0" }}>
            ...
            >
                ...
                <Text css={{ paddingRight: "$sm", marginBottom: "$sm" }}>
                    Je publie des articles sur le développement web, le clean
                    code et l'expérience développeur. Lorsqu'un sujet
                    m'intéresse, je tente d'en rédiger un article. N'hésitez pas
                    à me contacter afin d'améliorer leur qualité !
                </Text>
            </Grid>
            {featuredPosts.map(
                ({ title, slug, excerpt, duration, image }, index) => (
    ...
    return (
        ...
        >
            ...
            <Text css={{ paddingRight: "$sm" }}>
                Je pratique régulièrement des Katas de code. Ce sont des
                exercices de programmation visant à améliorer les compétences en
                développement en travaillant sur des problèmes précis.
            </Text>
        ...
        <Card variant="bordered" css={{ padding: "$sm" }}>
            ...
            <Row css={{ marginTop: "$sm" }}>
                <Text css={{ textAlign: "center" }}>
                    En quête de défis et d'opportunités pour grandir
                    professionnellement, je suis actuellement à la recherche
                    d'un contrat en alternance à Bordeaux{" "}
                    <Text i>(ou en télétravail)</Text>.
                </Text>
            </Row>
            <Row css={{ marginBottom: "$sm" }}>
                <Text css={{ textAlign: "center" }}>
                    Si vous souhaitez discuter de mes aspirations et de mes
                    compétences ou de n'importe quel sujet,
...
export const getStaticProps = () => {
    const featuredPostsSlug = [
        "environnement-de-developpement-windows-debian-partie-1-2",
        "les-katas",
    ];
